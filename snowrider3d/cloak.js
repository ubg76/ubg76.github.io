...
function addBtnHome(){
    ...
    e.id = 'inGame';
    e.innerHTML = `
    <img src="https://blackboro.github.io/games/logo-77games.png" width="130px" height="35px" alt="UBG 76 Unblocked">`;
...
if (window.location.href !== 'https://UBG 76 Unblocked/') {
...
function returnHome(){
    ...
    var newWindow = window.open("https://UBG 76 Unblocked", "_blank");
    newWindow.document.title = "UBG 76 Unblocked";
}
function opendiscord(){
    window.open("https://UBG 76 Unblocked");
}
